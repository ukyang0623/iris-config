...
-- 窗口间移动
keymap({ "n", "v" }, "<A-h>", "<C-w>h", { noremap = true, desc = "focus on left window" })
keymap({ "n", "v" }, "<A-j>", "<C-w>j", { noremap = true, desc = "focus on down window" })
keymap({ "n", "v" }, "<A-k>", "<C-w>k", { noremap = true, desc = "focus on up window" })
keymap({ "n", "v" }, "<A-l>", "<C-w>l", { noremap = true, desc = "focus on right window" })
-- 调整窗口大小
